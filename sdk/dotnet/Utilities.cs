...
namespace Pulumi.Openpgp
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Openpgp.version.txt");
    ...
    internal sealed class OpenpgpResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public OpenpgpResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
